...
<div class="container-fluid">
	...
	<div class="container-fluid">
		...
		<div style="margin: auto; text-align: center;">
			<a class="btn btn-primary" href="<%=request.getContextPath()%>/admin/selectEbookList.jsp?currentPage=1&categoryName=<%=categoryName%>">처음으로</a>
		<%
			if(currentPage != 1){
		%>
				<a class="btn btn-primary" href="<%=request.getContextPath()%>/admin/selectEbookList.jsp?currentPage=<%=currentPage-1%>&categoryName=<%=categoryName%>">이전</a>
		<%
			}
		...
		<%
			...
			%>
			<a class="btn btn-primary" href="<%=request.getContextPath()%>/admin/selectEbookList.jsp?currentPage=<%=lastPage%>&categoryName=<%=categoryName%>">끝으로</a>
		<%
		}
		%>
		</div>
