...
<div class="container-fluid">
	...
	<div style="margin: auto; text-align: center;">
		<a class="btn btn-primary" href="./selectMemberList.jsp?currentPage=1&searchMemberId=<%=searchMemberId%>">처음으로</a>
	<%
		if(currentPage != 1){
	%>
			<a class="btn btn-primary" href="./selectMemberList.jsp?currentPage=<%=currentPage-1%>&searchMemberId=<%=searchMemberId%>">이전</a>
	<%
		}
	...
	<%
		...
		%>
			<a class="btn btn-primary" href="./selectMemberList.jsp?currentPage=<%=currentPage+1%>&searchMemberId=<%=searchMemberId%>">다음</a>
		<%
		}
		%>
		<a class="btn btn-primary" href="./selectMemberList.jsp?currentPage=<%=lastPage%>&searchMemberId=<%=searchMemberId%>">끝으로</a>
	</div>
	<%
	}
	%>
